 ...
 * (the profile's breadcrumb position, the listing's inline link); `icon` is the compact circle for
 * a strip that has no room for a word — the sticky header bands, the entity view's start rail —
