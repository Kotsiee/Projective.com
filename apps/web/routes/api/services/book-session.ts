...
import { SessionBookingInputSchema } from "@projective/types/services";
...
export const handler = define.handlers({
	async POST(ctx) {
		...
		return toBookingResponse(await BookingBackendService.bookSession(parsed.data, bookingActorFrom(ctx)));
	},
});
