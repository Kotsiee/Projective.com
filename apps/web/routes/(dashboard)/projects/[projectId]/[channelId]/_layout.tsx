 ...
 *
 * Neither the contextual header NOR the Chat composer is rendered here anymore: both are mounted by the
 * shell into the middle-nav FRAME's configurable bands (Decision #31) — the {@link ChannelHeader} into
 * the sticky `header` band (resolved by `channelHeaderFor`) and the {@link ChatComposer} into the sticky
 ...
 * native window scroll between them. The layout now owns only the tab body wrapper.
 */
