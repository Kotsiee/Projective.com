 ...
 */
export default define.page(function ChannelTasksPage(ctx) {
	const { projectId, channelId } = ctx.params;
	const { page } = resolveBoardPage(projectId, channelId);
	return <ProjectBoard scope="channel" projectId={projectId} channelId={channelId} initial={page} />;
});
