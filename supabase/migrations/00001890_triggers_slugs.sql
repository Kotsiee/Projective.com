...
--
-- One trigger per slugged table, all four in one file on purpose. They are the same declaration
-- four times over, differing only in the prefix passed to `security.fn_slug_guard`, and keeping
-- them adjacent is what makes a divergence visible: a fifth slugged table added without a trigger
