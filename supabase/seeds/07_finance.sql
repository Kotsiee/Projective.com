...
VALUES
  ...
  ('d6f84d3b-73e4-47b4-abcb-c35df01ae22e', 'bcb2e130-1e59-4fa5-afbd-26be2e2f309b', 'service_session', 'eaff7484-81fb-46d3-adb1-42da56453eb9', 'Live portfolio review', '60-minute session', 1, 18000, 'USD', 'session', NULL, NULL, NULL, NULL, now() + interval '120 hours', 'Europe/London', 60, 'google', 0)
ON CONFLICT (id) DO NOTHING;
